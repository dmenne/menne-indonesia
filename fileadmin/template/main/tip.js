...
/* Dieter Menne, www.menne-indonesia.de */
function ShowMap(title,text,image) {
  var image1 = new Image();
  image1.src = image;
//  alert(image);
  var wi=image1.width;
  var hi=image1.height;  
  if (wi > 50 && hi > 50) {
  refText=["Titel","Text"]
  refStyle=["white","","","center","",2,  /* Title */
            "white","","","center","",2,  /* Text */
            image1.width,image1.height,  /* wi,he */
            2,"black", /* border */
            ,,,, /* pad,trans nu,dur,transp lev */
            2,"gray", /* shadow */
            1,,,]  /* Appearance,TipPos,xpos,ypos */
   refText[0]=title;
 	 refText[1]=text;
	 refStyle[8]=image;
	 stm(refText,refStyle);}
}
